...
'''
This method parses the file containing data for a particular restriction site and organizes all the data. 
'''
def siteParser(file):
    data = open(file, 'rU')
    ...
    print ' reads / res sites / CpG sites have been read'
    return reads
...
def organize(string):
    ...
    plist = [list[0], int(list[1]), int(list[2])]
