...
def primary_metastasis_recurrence():
    ...
    fhout = open('mutation_status_prim_metastasis_all_patients_V2_VarScan.csv', 'w')
    outline = 'CHRM,POS,REF,GENE,EFFECT_IMPACT,COSMIC,dbSNP_Clinical,ESP_EA,ESP_AFR_A,1000Gp1_AFR,1000Gp1_EUR,1000Gp1_AMR,1000Gp1,SIFT,GERP_RS,GERP_NR,logOdds,PolyPhen2,Composite_Score,Gene#AA,Num_Patients_Primary,Num_Patients_Metastasis,'
    outline+= 'ALT_1_P,AF_1_P,DP_1_P,RS_1_P,PV_1_P,'
    outline+= 'ALT_1_M,AF_1_M,DP_1_M,RS_1_M,PV_1_M,'

    outline+= 'ALT_2_P,AF_2_P,DP_2_P,RS_2_P,PV_2_P,'
    outline+= 'ALT_2_M,AF_2_M,DP_2_M,RS_2_M,PV_2_M,'

    outline+= 'ALT_3_P,AF_3_P,DP_3_P,RS_3_P,PV_3_P,'
    outline+= 'ALT_3_M,AF_3_M,DP_3_M,RS_3_M,PV_3_M,'

    outline+= 'ALT_6_P,AF_6_P,DP_3_P,RS_6_P,PV_6_P,'
    outline+= 'ALT_6_M,AF_6_M,DP_3_M,RS_6_M,PV_6_M,'

    outline+= 'ALT_9_P,AF_9_P,DP_9_P,RS_9_P,PV_9_P,'
    outline+= 'ALT_9_M,AF_9_M,DP_9_M,RS_9_M,PV_9_M,'

    outline+= 'ALT_10_P,AF_10_P,DP_10_P,RS_10_P,PV_10_P,'
    outline+= 'ALT_10_M,AF_10_M,DP_10_M,RS_10_M,PV_10_M,'

    outline+= 'ALT_11_P,AF_11_P,DP_11_P,RS_11_P,PV_11_P,'
    outline+= 'ALT_11_M,AF_11_M,DP_11_M,RS_11_M,PV_11_M,'

    outline+= 'ALT_12_P,AF_12_P,DP_12_P,RS_12_P,PV_12_P,'
    outline+= 'ALT_12_M,AF_12_M,DP_12_M,RS_12_M,PV_12_M,'

    outline+= 'ALT_13_P,AF_13_P,DP_13_P,RS_13_P,PV_13_P,'
    outline+= 'ALT_13_M,AF_13_M,DP_13_M,RS_13_M,PV_13_M,'
    ...
    allLocations = Set(allDeleterious.keys()) | Set(allDeleteriousMet.keys())
...
Exon [ | ERRORS | WARNINGS ] )'''
        ...
        outline = chrm +','+ position +','+REF +','+ gene+','+ effect_impact +',' +cosmic_check + ','+ dbSNP_check+ ',' +mut_info[13] + ','+mut_info[14] +',' +mut_info[15]+','+mut_info[16] + ',' + mut_info[17] +',' +mut_info[18]+',' + sift+ ',' +gerp_rs+ ',' +gerp_nr+ ',' +logOdds+ ',' +polyPhen2+ ',' +comp_score + ','+gene_aa_mut +',' + str(num_patient_prim) +',' + str(num_patient_met) + ','
##        fhout.write(outline)
