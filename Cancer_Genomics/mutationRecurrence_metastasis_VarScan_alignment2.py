...
##    del commonEVS, agilentCommon,IlluminaCommon,Illumina_agilent,dbSNPcommon
    ...
    for eachTumor in files:
        ...
        delMutPickleName = prim[:end] + '_brain_VarScan_clean_snpEff_SnpSift_rare_del.pkl'  #-----========---------========--------
...
def recurrentMut2CSV():
    ...
    mutation_info_dict = pickle.load(open('met_mutation_info_dict_new.pkl', 'rU'))   #/////----///---////----
    ...
    fhout = open('mutation_recurrence_results_metastasis_VarScan.csv', 'w')   #---------========---------=
