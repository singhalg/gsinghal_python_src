...
# this  calls binaryS() method, which is a recursive implementation of binary search. The method is present in Overlap.py
    ...
    printScore1(Newconsensus, readCount, repFamily) #present in Analyzer1.py. This method prints the consensus to an output file
...
def printScore1(consensus, readCount, repFamily):
