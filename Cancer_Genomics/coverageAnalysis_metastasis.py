...
def coverage():
    ...
    allPatientLocations = pickle.load(open('allPatientsMetastasisLocations.pkl', 'rU'))
    allPatientCoverage = {}
    ...
    for each in pt_list:
        ...
        fileName = each + '_brain_mpileup.txt'
        fh = open(fileName, 'rU')
        for line in fh:
            flds = line.split('\t')
...
##    fhCoverageList.close()
    ...
    fhAllCoverage = open('allPatientsMetastasisCoverage.pkl', 'w')
...
def surveyLocations():
    ...
    for each in pt_list:
        ...
        for line in fh:
            ...
            del flds, key
        fh.close()
    fhLocations = open('allPatientsMetastasisLocations.pkl', 'w')
