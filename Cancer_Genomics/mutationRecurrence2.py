...
##    del commonEVS, agilentCommon,IlluminaCommon,Illumina_agilent,dbSNPcommon
    ...
    for eachTumor in files:
        ...
        delMutPickleName = prim[:end]+ '_lung_VarScan_clean_snpEff_SnpSift_rare_del.pkl'
        ...
        for eachLoc in delMutLocations:  #/////----///---////----
            ...
            if eachLoc not in allCommon:  # considering only those locations which are non-common variants
                ...
                for i in range(len(AF)):
                    if (float(AF[i]) >= 0.1) and (int(DP[0])>=20): # this will also shorten the list of variants by quite a lot
...
##                    predictions = {}
                    ...
                    if'dbnsfpPolyphen2_HVAR_pred' in info:
                    ...
                    if'dbnsfp29way_logOdds' in info:
...
##                    mut_info.append(info['dbnsfpSIFT_score'])  # these scores can be replaced by real scores too
...
##
##
##                    mut_info.append(info['GERP'])
##                    mut_info.append(info['dbnsfp29way_logOdds'])
##                    mut_info.append(info['PolyPhen2'])
##
##                    mut_info.append(info['EFF'])
    ...
    allDeleteriousPickle = open('All_deleterious_rare.pkl', 'w')  #/////----///---////----
...
##    allCommon = commonEVS | agilentCommon | IlluminaCommon | Illumina_agilent | dbSNPcommon
    ...
    fhAllDeleterious = open('All_deleterious_rare.pkl', 'rU') #/////----///---////----
...
##        print eachMostRecurrent, '   # of patients having this mutation = ', eachMostRecurrent[1]
    ...
    print 'Finished calculating recurrence'
...
def recurrentMut2CSV():
    ...
    allDeleterious = pickle.load(open('All_deleterious_rare.pkl', 'rU')) #/////----///---////----
    ...
    outline = 'CHRM,POS,REF,GENE,EFFECT_IMPACT,COSMIC,dbSNP_Clinical,SIFT,GERP_RS,GERP_NR,logOdds,PolyPhen2,Composite_Score,Gene#AA,Num_Patients,PT_NAME,ALT,AF,DEPTH,READ_SUPPORT' + '\n'
    fhout.write(outline)
...
Exon [ | ERRORS | WARNINGS ] )'''
        ...
        outline = chrm +','+ position +','+REF +','+ gene+','+ effect_impact +',' +cosmic_check + ','+ dbSNP_check+ ',' + sift+ ',' +gerp_rs+ ',' +gerp_nr+ ',' +logOdds+ ',' +polyPhen2+ ',' +comp_score + ','+gene_aa_mut +',' + str(eachLoc[1])+'\n'
        fhout.write(outline)
