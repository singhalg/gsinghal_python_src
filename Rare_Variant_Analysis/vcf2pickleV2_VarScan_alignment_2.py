...
##                [ 'PT_2_lung_1123231.vcf', 'PT_2_brain_1123230.vcf']  ]
    ...
    fhout_file = 'variant_detection_stats_' + dbSNP_pickle[:-4] +'.csv'
...
#   write code here
    ...
    internal_control = pickle.load(open('recurrent_mutations.pkl', 'rU'))
...
##    del commonEVS, agilentCommon,IlluminaCommon,Illumina_agilent,dbSNPcommon
    ...
    for each in fileList:
        ...
        vcfFile = bamFile[:-4]+'_snpEff_SnpSift_GWAS.vcf'
