...
def readAllMutations():
    ...
    files = ['2221_true_positives.pkl', '2359_true_positives.pkl', '2556_true_positives.pkl', '3466_true_positives.pkl']
##
...
##        delMutPickleName = prim[:-4] + '_snpEff_SnpSift_rare_del.pkl'
        ...
        end = delMutPickleName.find('_true')   ####----------------==============----------===========-------------=============
...
##                    predictions = {}
    ...
    allDeleteriousPickle = open('All_deleterious_truePositives_rare.pkl', 'w')  #/////----///---////----
    pickle.dump(allDeleterious, allDeleteriousPickle)
    allDeleteriousPickle.close()

    mut_info_pickle = open('truePositives_mutation_info_dict_new.pkl', 'w')  #---===----====---
...
##    allCommon = commonEVS | agilentCommon | IlluminaCommon | Illumina_agilent | dbSNPcommon
    ...
    fhAllDeleterious = open('All_deleterious_truePositives_rare.pkl', 'rU') #/////----///---////----
...
##        if eachLoc not in allCommon: # here, we are taking only those locations which are not present in any of the internal or external common snps
    ...
    fhRecurrentMutList = open('truePositives_recurrent_mutation_list.pkl', 'w')  #/////----///---////----
...
def recurrentMut2CSV():
    recurrentMutList = pickle.load(open('truePositives_recurrent_mutation_list.pkl', 'rU')) #/////----///---////----
    allDeleterious = pickle.load(open('All_deleterious_truePositives_rare.pkl', 'rU')) #/////----///---////----
    mutation_info_dict = pickle.load(open('truePositives_mutation_info_dict_new.pkl', 'rU'))   #/////----///---////----
    ...
    fhout = open('mutation_recurrence_results_tumor_normal_true_positives_VarScan.csv', 'w')   #---------========---------=
...
##    mutation_info_dict_metastasis = pickle.load(open('met_mutation_info_dict_new.pkl', 'rU')) #///----////----///
    ...
    fhout = open('mutation_recurrence_results_tumor_normal_true_positives_VarScan_V2_flat_file.csv', 'w')
