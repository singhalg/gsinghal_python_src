...
def mutationRecurrence(recurrence_level):
    ...
    for each in fileList:
        ...
        pickleFile = bamFile[:-4]+'_snpEff_SnpSift_GWAS_del.pkl'
    ...
    recurrentVariants = returnVariants(mutation_patient_dict, recurrence_level)

    pickle.dump(mutation_patient_dict, open('mutation_patient_dict.pkl', 'w'))

    pickle.dump(recurrentVariants, open('recurrent_mutations.pkl', 'w'))




def returnVariants(mutation_patient_dict, recurrence_level):
    variant_set = Set()
...
def geneRecurrence():
    ...
    for each in fileList:
        ...
        pickleFile = bamFile[:-4]+'_snpEff_SnpSift_GWAS_rare_del.pkl'
...
def geneByPatient():
    ...
    for each in fileList:
        ...
        patient_list.append(each.split(',')[0].strip()[:-4])
