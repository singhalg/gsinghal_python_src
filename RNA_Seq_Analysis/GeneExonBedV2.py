...
def writeExons(geneName, uniqueGenes, dict):
    ...
    for x in range(int(exonCount)):
        ...
        exonBedEntry  = chrom + '\t' +  exonSt[x] + '\t' + exonE[x] + '\t' + name + '\t'+ exonCount + '\t' + strand + '\t' + txnStart + '\t' + txnEnd + '\t' +rgb + '\t' +exonCount + '\t' + exonSizes + '\t' + ExonStart + '\n' 
...
def writeExonsBrief(geneName, uniqueGenes, dict):
    ...
    for x in range(int(exonCount)):
        ...
        exonBedEntry  = chrom + '\t' +  exonSt[x] + '\t' + exonE[x] + '\t' + name + '\t'+ exonCount + '\t' + strand +  '\n' 
        Exons+=exonBedEntry                 
