...
##    print '# of all variants in dbSNP file = ', len(fh)
    print '# of variants with in all_common.vcf : ', len(variantsVCF.keys())
    fhPickledbSNP = open('dbSNP_allCommon_gmaf_5.pkl', 'w')
...
##
    if ('GMAF' in value) and (float(value['GMAF'][0]) >=0.05):
