...
# This work belongs to Colin McDonough; this script was written for a project in Machine Learning Class that I (Gaurav Singhal) and Colin McDonough collaborated on.
import time
