...
def SuperSiteAnalyzer(SiteFile1, SiteFile2, SiteFile3, RepeatFile1, 
                      RepeatFile2, RepeatFile3, RepeatFile4, RepeatFile5, RepeatFile6,
                      RepeatFile7, RepeatFile8, RepeatFile9, RepeatFile10 , RepeatFile11):
    #==============Constructing Lists of Site data ==========================================    
    site1 = siteParser(SiteFile1)
    site2 = siteParser(SiteFile2)
    site3 = siteParser(SiteFile3)
    
    list = [RepeatFile1, RepeatFile2, RepeatFile3, RepeatFile4, RepeatFile5, RepeatFile6, RepeatFile7, RepeatFile8, RepeatFile9, RepeatFile10 , RepeatFile11]
...
def main():
    ...
    SiteFile1 = sys.argv[12]
    SiteFile2 = sys.argv[13]
    SiteFile3 = sys.argv[14]
    
    
    
    SuperSiteAnalyzer(SiteFile1, SiteFile2, SiteFile3, RepeatFile1, RepeatFile2, RepeatFile3, 
                      RepeatFile4, RepeatFile5, RepeatFile6, RepeatFile7, RepeatFile8, RepeatFile9,
                    RepeatFile10 , RepeatFile11)
